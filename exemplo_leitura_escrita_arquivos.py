...
def criar_arquivo_txt():
    with open("mensagens.txt", "w", encoding="utf-8") as arquivo:
        arquivo.write("Olá Mundo, Matheus Aqui!\n")
        arquivo.write("O Céu está lindo Hoje!!\n")
        arquivo.write("Que bom que não choveu")
...
def criar_arquivo_csv():
    ...
    if caminho.exists():
        ...
        print("Não existe o arquivo de missões")

        # Informa que o arquivo será criado
        print("Criando arquivo de missões")
...
def obter_missoes() -> list[Missao]:
    ...
    with open("personagens.csv", "r", encoding="utf-8") as arquivo:
        ...
        for linha in arquivo:
            ...
            # Data, personagem, quantidade = partes >>>>>>> Outra opção para a parte de cima
